...
public class CastleHiredGuardDAO
{
	...
	{
		return CastleHiredGuardDAO._instance;
	}
	...
	public void load(final Castle r)
	{
		...
		{
			CastleHiredGuardDAO._log.error("CastleHiredGuardDAO:load(Castle): " + e, e);
		}
		finally
		{
	...
	public void insert(final Residence residence, final int itemId, final Location loc)
	{
		...
		{
			CastleHiredGuardDAO._log.error("CastleHiredGuardDAO:insert(Residence, int, Location): " + e, e);
		}
		finally
		{
	...
	public void delete(final Residence residence, final ItemInstance item)
	{
		...
		{
			CastleHiredGuardDAO._log.error("CastleHiredGuardDAO:delete(Residence): " + e, e);
		}
		finally
		{
			DbUtils.closeQuietly(con, statement);
